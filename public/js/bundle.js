...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*eslint-disable */
var stripe = Stripe('pk_test_51T0IMo0FGNXlRHOfMiP934CXsmRwkQee6ehpfUplfIvutNW62AvQmmSlV0Hkl0OwwiT1vs3saeexNZhZQm9C8oFF00WS37GYB6');
...
var createReview = exports.createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tour, rating, review) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            ...
            window.setTimeout(function () {
              location.assign("/tour/".concat(res.data.data.data.tour.slug));
            }, 1500);
          }
          _context.n = 3;
          break;
...
if (resetPasswordForm) resetPasswordForm.addEventListener('submit', function (e) {
  ...
  var password = document.getElementById('password').value;
  var passwordConfirm = document.getElementById('passwordConfirm').value;
  var token = document.querySelector('.btn--reset-password').dataset.token;
